                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="selectgroup w-100">
                                            <label class="selectgroup-item">
                                                <input type="radio" name="home_page_pagebuilder" value="1" class="selectgroup-input" {{$bs->home_page_pagebuilder == 1 ? 'checked' : ''}}>
                                                <span class="selectgroup-button">Active</span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="radio" name="home_page_pagebuilder" value="0" class="selectgroup-input" {{$bs->home_page_pagebuilder == 0 ? 'checked' : ''}}>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="theme_version">
                                            ...
                                            <option selected value="news-portal" {{$bs->theme_version == 'news-portal' ? 'selected' : ''}}>The News Portal</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-12">
