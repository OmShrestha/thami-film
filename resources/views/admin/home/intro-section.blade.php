          ...
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="ajaxForm" action="{{route('admin.introsection.update', $lang_id)}}" method="post">
                ...
                <div class="row">
                    <div class="{{$bs->theme_version == 'logistic' || $bs->theme_version == 'lawyer' ? 'col-lg-6' : 'col-lg-12'}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="thumb-preview" id="thumbPreview1">
                                <img src="{{asset('assets/frontend/images/'.$bs->intro_bg)}}" alt="Image">
                            </div>
                            <br>
                            <br>
                    ...
                    @if ($bs->theme_version == 'logistic' || $bs->theme_version == 'lawyer')
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="thumb-preview" id="thumbPreview2">
                                    <img src="{{asset('assets/frontend/images/'.$bs->intro_bg2)}}" alt="Image">
                                </div>
                                <br>
                                <br>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="intro_section_title" value="{{$bs->intro_section_title}}">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control ltr" name="intro_section_video_link" value="{{$bs->intro_section_video_link}}">
                          <p class="text-warning mb-0">Link will be formatted automatically after submitting form.</p>
                          <p id="err_intro_section_video_link" class="em text-danger mb-0"></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea name="intro_section_text" class="form-control summernote" data-height="300">{{$bs->intro_section_text}}</textarea>
                            <p id="err_intro_section_text" class="em text-danger mb-0"></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="intro_section_button_text" value="{{$bs->intro_section_button_text}}">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control ltr" name="intro_section_button_url" value="{{$bs->intro_section_button_url}}">
