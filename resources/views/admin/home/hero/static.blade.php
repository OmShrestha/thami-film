              ...
              <form id="ajaxForm" action="{{route('admin.herosection.update', $lang_id)}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="thumb-preview" id="thumbPreview1">
                        <img src="{{asset('assets/frontend/images/' . $bs->hero_bg)}}" alt="Image">
                    </div>
                    <br>
                    <br>
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="form-group">
                          ...
                          <textarea rows="4" type="text" class="form-control" name="hero_section_title" value="{{$bs->hero_section_title}}">{{$bs->hero_section_title}}</textarea>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control ltr" name="hero_section_title_font_size" value="{{$bs->hero_section_title_font_size}}">
                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="form-group">
                                ...
                                <textarea rows="4" name="hero_section_bold_text" class="form-control" value="{{$bs->hero_section_bold_text}}">{{$bs->hero_section_bold_text}}</textarea>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                              ...
                              <input type="number" class="form-control ltr" name="hero_section_bold_text_font_size" value="{{$bs->hero_section_bold_text_font_size}}">
                    ...
                    {{-- <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="">Bold Text</label>
                                <textarea rows="4" name="hero_section_bold_text_color" class="form-control jscolor" value="{{$bs->hero_section_bold_text_color}}"></textarea>
                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            ...
                            <textarea rows="4" name="hero_section_text" class="form-control" value="{{$bs->hero_section_text}}">{{$bs->hero_section_text}}</textarea>
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="number" class="form-control ltr" name="hero_section_text_font_size" value="{{$bs->hero_section_text_font_size}}">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control ltr" name="hero_section_button_text_font_size" value="{{$bs->hero_section_button_text_font_size}}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control ltr" name="hero_section_button_url" value="{{$bs->hero_section_button_url}}">
