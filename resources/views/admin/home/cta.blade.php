              ...
              <form id="ctaForm" action="{{route('admin.cta.update', $lang_id)}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="thumb-preview" id="thumbPreview1">
                        <img src="{{asset('assets/frontend/images/' . $bs->cta_bg)}}" alt="Background">
                    </div>
                    <br>
                    <br>
                ...
                <div class="form-group">
                  ...
                  <input name="cta_section_text" class="form-control" value="{{$bs->cta_section_text}}">
                  <p id="errcta_section_text" class="em text-danger mb-0"></p>
                </div>
                <div class="form-group">
                  <label for="">Button Text **</label>
                  <input type="text" class="form-control" name="cta_section_button_text" value="{{$bs->cta_section_button_text}}">
                  <p id="errcta_section_button_text" class="em text-danger mb-0"></p>
                </div>
                <div class="form-group">
                  <label for="">Button URL **</label>
                  <input type="text" class="form-control ltr" name="cta_section_button_url" value="{{$bs->cta_section_button_url}}">
