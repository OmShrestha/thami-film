                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                            <a href="#" class="btn btn-primary float-right btn-sm" data-toggle="modal" data-target="#createModal"><i
                                    class="fas fa-plus"></i> Add News Category</a>
                            <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete"
                                    data-href="{{route('admin.news-category.bulk.delete')}}"><i class="flaticon-interface-5"></i>
                                Delete
                            </button>
                        </div>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-secondary btn-sm editbtn" href="#editModal"
                                                       data-toggle="modal" data-news_category_id="{{$category->id}}"
                              ...
                              <span class="btn-label">
                                <i class="fas fa-edit"></i>
                                                    ...
                                                    <form class="deleteform d-inline-block"
                                                          action="{{route('admin.news-category.delete')}}" method="post">
                                                        @csrf
                                                        <input type="hidden" name="news_category_id" value="{{$category->id}}">
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="d-inline-block mx-auto">
                            {{$newsCategories->appends(['language' => request()->input('language')])->links()}}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="ajaxForm" class="modal-form create" action="{{route('admin.news-category.store')}}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-warning"><small>The higher the serial number is, the later the news category will be
                                    shown.</small></p>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="ajaxEditForm" class="" action="{{route('admin.news-category.update')}}" method="POST">
                        @csrf
                        <input id="innews_category_id" type="hidden" name="news_category_id" value="">
                        <div class="form-group">
                            <label for="">Name **</label>
