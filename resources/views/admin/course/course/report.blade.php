                    ...
                    <tbody>
                      @foreach ($enrolls as $key => $row)
                        <tr>
                          ...
                          <td>{{$bs->base_currency_symbol_position == 'left' ? $bs->base_currency_symbol : ''}}{{$row->current_price}}{{$bs->base_currency_symbol_position == 'right' ? $bs->base_currency_symbol : ''}}</td>
