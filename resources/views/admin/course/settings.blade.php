               ...
               <div class="col-lg-12">
                  <form id="settingsForm" class="" action="{{route('admin.course.settings')}}" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                        ...
                        <div class="selectgroup w-100">
                              <label class="selectgroup-item">
                                  <input type="radio" name="is_course" value="1" class="selectgroup-input" {{$bs->is_course == 1 ? 'checked' : ''}}>
                                  <span class="selectgroup-button">Active</span>
                              </label>
                              <label class="selectgroup-item">
                                  <input type="radio" name="is_course" value="0" class="selectgroup-input" {{$bs->is_course == 0 ? 'checked' : ''}}>
                     ...
                     <div class="form-group">
                        ...
                        <div class="selectgroup w-100">
                              <label class="selectgroup-item">
                                  <input type="radio" name="is_course_rating" value="1" class="selectgroup-input" {{$bs->is_course_rating == 1 ? 'checked' : ''}}>
                                  <span class="selectgroup-button">Active</span>
                              </label>
                              <label class="selectgroup-item">
                                  <input type="radio" name="is_course_rating" value="0" class="selectgroup-input" {{$bs->is_course_rating == 0 ? 'checked' : ''}}>
                                  <span class="selectgroup-button">Deactive</span>
                              </label>
                        </div>
                     </div>
