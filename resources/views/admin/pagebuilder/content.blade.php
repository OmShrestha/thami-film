...
<head>
    ...
    <link rel="icon" href="{{asset('assets/frontend/images/'.$bs->favicon)}}">
...
<script type="text/javascript">
    ...
    var editor = grapesjs.init({
        ...
        assetManager: {
            ...
            upload: "{{url('assets/frontend/images/pagebuilder')}}", //for temporary storage
            assets: [],
        ...
        canvas: {
            styles: [
                "{{asset('assets/frontend/css/bootstrap.min.css')}}",
                "{{asset('assets/frontend/css/plugin.min.css')}}",
                "{{asset('assets/frontend/css/common-style.css')}}",
                "{{asset('assets/admin/css/pb-canvas.css?time=' . time())}}",
                "{{url('/')}}/assets/frontend/css/base-color.php?color={{$bs->base_color}}&color1={{$bs->secondary_base_color}}",
            ],
            scripts: [
                "{{asset('assets/admin/js/jquery-3.3.1.min.js')}}",
                // "{{asset('assets/admin/js/popper.min.js')}}",
                "{{asset('assets/admin/js/bootstrap.min.js')}}",
