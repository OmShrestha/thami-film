              ...
              <form id="ajaxForm" action="{{route('admin.footer.update', $lang_id)}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="thumb-preview" id="thumbPreview1">
                        <img src="{{asset('assets/frontend/images/'.$bs->footer_logo)}}" alt="Footer Logo">
                    </div>
                    <br>
                    <br>
                ...
                <div class="form-group">
                  ...
                  <textarea id="copyright_text" name="copyright_text" class="summernote form-control" data-height="150">{{convertHtml($bs->copyright_text)}}</textarea>
