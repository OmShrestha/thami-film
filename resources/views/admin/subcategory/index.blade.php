...
@section('content')
    <div class="page-header">
        <h4 class="page-title">Blog Subcategories</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                            <a href="#" class="btn btn-primary float-right btn-sm" data-toggle="modal" data-target="#createModal"><i
                                    class="fas fa-plus"></i> Add Subcategory</a>
                            <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete"
                                    data-href="{{route('admin.subcategory.bulk.delete')}}"><i class="flaticon-interface-5"></i>
                                Delete
                            </button>
                        </div>
                    </div>
                                    ...
                                    <table class="table table-striped mt-3">
                                        ...
                                        @foreach ($subcategories as $key => $subcategory)
                                            <tr>
                                                ...
                                                <td>{{$subcategory->bcategory?->name}}</td>
                                                <td>
                                                ...
                                                <td>
                                                    <a class="btn btn-secondary btn-sm editbtn" href="#editModal"
                                                       data-toggle="modal" data-bcategory_id="{{$subcategory->bcategory_id}}"
                                                       data-subcategory_id="{{$subcategory->id}}" data-siteId="{{$subcategory->site_id}}"
                                                       data-name="{{$subcategory->name}}" data-status="{{$subcategory->status}}"
                              ...
                              <span class="btn-label">
                                <i class="fas fa-edit"></i>
                                                    ...
                                                    <form class="deleteform d-inline-block"
                                                        ...
                                                        @csrf
                                                        <input type="hidden" name="bcategory_id" value="{{$subcategory->id}}">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="ajaxForm" class="modal-form create" action="{{route('admin.subcategory.store')}}" method="POST">
                        @csrf
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="ajaxEditForm" class="" action="{{route('admin.subcategory.update')}}" method="POST">
                        @csrf
                        <input id="insubcategory_id" type="hidden" name="subcategory_id" value="">
                        <div class="form-group">
                            <label for="">Name **</label>
                        ...
                        <div class="form-group">
                            <label for="">Category **</label>
                            <select name="bcategory_id" id="inbcategory_id" class="form-control">
                                <option disabled>Select a category</option>
                                @foreach ($bcategories as $category)
                                    <option value="{{ $category->id }}">{{ $category->name }}</option>
                                @endforeach
                            </select>
                            <p id="eerrbcategory_id" class="mb-0 text-danger em"></p>
                        </div>
                        <div class="form-group">
                            <label for="">Status **</label>
