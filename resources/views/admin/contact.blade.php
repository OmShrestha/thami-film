          ...
          <div class="card-body pt-5 pb-5">
            <div class="row">
              <div class="col-lg-12 mx-auto">
                ...
                <div class="form-group">
                  <label>Address **</label>
                  <textarea class="form-control" name="contact_addresses" rows="3">{{$bs->contact_addresses}}</textarea>
                  <p class="mb-0 text-warning">Use newline to separate multiple addresses.</p>
                ...
                <div class="form-group">
                  <label>Phone **</label>
                  <input class="form-control" name="contact_numbers" data-role="tagsinput" value="{{$bs->contact_numbers}}" placeholder="Enter Phone Number">
                  <p class="mb-0 text-warning">Use comma (,) to separate multiple contact numbers.</p>
                ...
                <div class="form-group">
                  <label>Email **</label>
                  <input class="form-control ltr" name="contact_mails" data-role="tagsinput" value="{{$bs->contact_mails}}" placeholder="Enter Email Address">
                  <p class="mb-0 text-warning">Use comma (,) to separate multiple contact mails.</p>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="latitude" value="{{$bs->latitude}}" placeholder="Enter Google Map Address">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="longitude" value="{{$bs->longitude}}" placeholder="Enter Google Map Address">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="map_zoom" value="{{$bs->map_zoom}}" placeholder="Enter Google Map Address">
