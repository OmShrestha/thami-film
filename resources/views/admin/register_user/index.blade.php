        ...
        <div class="card-header">
            <div class="row justify-content-between">
                ...
                <div class="col-lg-4 mt-2 mt-lg-0">
                    <button class="btn btn-danger btn-sm ml-2 mt-1 d-none bulk-delete" data-href="{{route('register.user.bulk.delete')}}"><i class="flaticon-interface-5"></i> Delete</button>
                ...
                <div class="col-lg-3 text-right">
                    <a href="{{ route('admin.register.user.add') }}" class="btn btn-primary float-right btn-sm">
