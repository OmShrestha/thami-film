            ...
            <div class="row">
              <div class="col-lg-12 mx-auto">
                ...
                <div class="form-group">
                  ...
                  <div class="selectgroup w-100">
                    <label class="selectgroup-item">
                      <input type="radio" name="is_smtp" value="1" class="selectgroup-input" {{$bs->is_smtp == 1 ? 'checked' : ''}}>
                      <span class="selectgroup-button">Active</span>
                    </label>
                    <label class="selectgroup-item">
                      <input type="radio" name="is_smtp" value="0" class="selectgroup-input" {{$bs->is_smtp == 0 ? 'checked' : ''}}>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="smtp_host" value="{{$bs->smtp_host}}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="smtp_port" value="{{$bs->smtp_port}}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="encryption" value="{{$bs->encryption}}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="smtp_username" value="{{$bs->smtp_username}}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="password" name="smtp_password" value="{{$bs->smtp_password}}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="email" name="from_mail" value="{{$bs->from_mail}}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="from_name" value="{{$bs->from_name}}">
