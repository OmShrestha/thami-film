            ...
            <div class="col-lg-12 mx-auto">
                <table class="table table-striped mb-5" style="border: 1px solid #0000005a;">
                    ...
                    <tbody>
                        ...
                        @if ($template->email_type != 'email_verification' && $template->email_type != 'donation' && $template->email_type != 'volunteer_form_submit')
                        <tr>
                          <td>
                            {customer_name}
                          </td>
                        ...
                        @if ($template->email_type == 'volunteer_form_submit')
                        <tr>
                          <td>
                            {volunteer_name}
                          </td>
