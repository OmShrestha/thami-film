            ...
            <div class="row">
              <div class="col-lg-12 mx-auto">
                ...
                <div class="form-group">
                  ...
                  <div class="selectgroup w-100">
                    <label class="selectgroup-item">
                        <input type="radio" name="cookie_alert_status" value="1" class="selectgroup-input" {{$bs->cookie_alert_status == 1 ? 'checked' : ''}}>
                        <span class="selectgroup-button">Active</span>
                    </label>
                    <label class="selectgroup-item">
                        <input type="radio" name="cookie_alert_status" value="0" class="selectgroup-input" {{$bs->cookie_alert_status == 0 ? 'checked' : ''}}>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="cookie_alert_button_text" value="{{$bs->cookie_alert_button_text}}">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control summernote" name="cookie_alert_text" rows="3" placeholder="Enter Cookie Alert Text" data-height="100">{{convertHtml($bs->cookie_alert_text)}}</textarea>
