                ...
                <div class="row">
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="service_title"
                      value="{{empty(old('service_title')) ? $bs->service_title : old('service_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="service_subtitle"
                      value="{{empty(old('service_subtitle')) ? $bs->service_subtitle : old('service_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="service_details_title"
                      value="{{empty(old('service_details_title')) ? $bs->service_details_title : old('service_details_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="portfolio_title"
                      value="{{empty(old('portfolio_title')) ? $bs->portfolio_title : old('portfolio_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="portfolio_subtitle"
                      value="{{empty(old('portfolio_subtitle')) ? $bs->portfolio_subtitle : old('portfolio_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="portfolio_details_title"
                      value="{{empty(old('portfolio_details_title')) ? $bs->portfolio_details_title : old('portfolio_details_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="faq_title"
                      value="{{empty(old('faq_title')) ? $bs->faq_title : old('faq_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="faq_subtitle"
                      value="{{empty(old('faq_subtitle')) ? $bs->faq_subtitle : old('faq_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="pricing_title"
                      value="{{empty(old('pricing_title')) ? $bs->pricing_title : old('pricing_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="pricing_subtitle"
                      value="{{empty(old('pricing_subtitle')) ? $bs->pricing_subtitle : old('pricing_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="product_title"
                      value="{{empty(old('product_title')) ? $bs->product_title : old('product_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="product_subtitle"
                      value="{{empty(old('product_subtitle')) ? $bs->product_subtitle : old('product_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="product_details_title"
                      value="{{empty(old('product_details_title')) ? $bs->product_details_title : old('product_details_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="cart_title"
                      value="{{empty(old('cart_title')) ? $bs->cart_title : old('cart_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="cart_subtitle"
                      value="{{empty(old('cart_subtitle')) ? $bs->cart_subtitle : old('cart_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="checkout_title"
                      value="{{empty(old('checkout_title')) ? $bs->checkout_title : old('checkout_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="checkout_subtitle"
                      value="{{empty(old('checkout_subtitle')) ? $bs->checkout_subtitle : old('checkout_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="knowledgebase_title"
                      value="{{empty(old('knowledgebase_title')) ? $bs->knowledgebase_title : old('knowledgebase_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="knowledgebase_subtitle"
                      value="{{empty(old('knowledgebase_subtitle')) ? $bs->knowledgebase_subtitle : old('knowledgebase_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="knowledgebase_details_title"
                      value="{{empty(old('knowledgebase_details_title')) ? $bs->knowledgebase_details_title : old('knowledgebase_details_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="blog_title"
                      value="{{empty(old('blog_title')) ? $bs->blog_title : old('blog_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="blog_subtitle"
                      value="{{empty(old('blog_subtitle')) ? $bs->blog_subtitle : old('blog_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="blog_details_title"
                      value="{{empty(old('blog_details_title')) ? $bs->blog_details_title : old('blog_details_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="rss_title"
                      value="{{empty(old('rss_title')) ? $bs->rss_title : old('rss_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="rss_subtitle"
                      value="{{empty(old('rss_subtitle')) ? $bs->rss_subtitle : old('rss_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="rss_details_title"
                      value="{{empty(old('rss_details_title')) ? $bs->rss_details_title : old('rss_details_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="gallery_title"
                      value="{{empty(old('gallery_title')) ? $bs->gallery_title : old('gallery_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="gallery_subtitle"
                      value="{{empty(old('gallery_subtitle')) ? $bs->gallery_subtitle : old('gallery_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="career_title"
                      value="{{empty(old('career_title')) ? $bs->career_title : old('career_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="career_subtitle"
                      value="{{empty(old('career_subtitle')) ? $bs->career_subtitle : old('career_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="course_title"
                      value="{{empty(old('course_title')) ? $bs->course_title : old('course_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="course_subtitle"
                      value="{{empty(old('course_subtitle')) ? $bs->course_subtitle : old('course_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="course_details_title"
                      value="{{empty(old('course_details_title')) ? $bs->course_details_title : old('course_details_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="event_calendar_title"
                      value="{{empty(old('event_calendar_title')) ? $bs->event_calendar_title : old('event_calendar_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="event_calendar_subtitle"
                      value="{{empty(old('event_calendar_subtitle')) ? $bs->event_calendar_subtitle : old('event_calendar_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="team_title"
                      value="{{empty(old('team_title')) ? $bs->team_title : old('team_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="team_subtitle"
                      value="{{empty(old('team_subtitle')) ? $bs->team_subtitle : old('team_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="contact_title"
                      value="{{empty(old('contact_title')) ? $bs->contact_title : old('contact_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="contact_subtitle"
                      value="{{empty(old('contact_subtitle')) ? $bs->contact_subtitle : old('contact_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="quote_title"
                      value="{{empty(old('quote_title')) ? $bs->quote_title : old('quote_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="quote_subtitle"
                      value="{{empty(old('quote_subtitle')) ? $bs->quote_subtitle : old('quote_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="error_title"
                      value="{{empty(old('error_title')) ? $bs->error_title : old('error_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="error_subtitle"
                      value="{{empty(old('error_subtitle')) ? $bs->error_subtitle : old('error_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="event_title"
                      value="{{empty(old('event_title')) ? $bs->event_title : old('event_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="event_subtitle"
                      value="{{empty(old('event_subtitle')) ? $bs->event_subtitle : old('event_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="event_details_title"
                      value="{{empty(old('event_details_title')) ? $bs->event_details_title : old('event_details_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="cause_title"
                      value="{{empty(old('cause_title')) ? $bs->cause_title : old('cause_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="cause_subtitle"
                      value="{{empty(old('cause_subtitle')) ? $bs->cause_subtitle : old('cause_subtitle')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="cause_details_title"
                      value="{{empty(old('cause_details_title')) ? $bs->cause_details_title : old('cause_details_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="client_feedback_title"
                      value="{{empty(old('client_feedback_title')) ? $bs->client_feedback_title : old('client_feedback_title')}}">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input class="form-control" name="client_feedback_subtitle"
                      value="{{empty(old('client_feedback_subtitle')) ? $bs->client_feedback_subtitle : old('client_feedback_subtitle')}}">
