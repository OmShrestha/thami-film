                ...
                <form id="maintenanceForm" action="{{route('admin.maintainance.update')}}" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <div class="thumb-preview" id="thumbPreview1">
                        <img src="{{asset('assets/frontend/images/maintainance.png?'.time())}}" alt="Maintenance">
                    </div>
                    <br>
                    <br>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="maintenance_text" rows="3" cols="80">{!! ($bs->maintenance_text) !!}</textarea>
