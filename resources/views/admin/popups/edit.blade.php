                        ...
                        <form id="ajaxForm" class="modal-form" action="{{route('admin.popup.update')}}" method="post">
                            ...
                            @if ($type == 1 || $type == 4 || $type == 5 || $type == 7)
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="thumb-preview" id="thumbPreview1">
                                        <img src="{{asset('assets/frontend/images/popups/' . $popup->image)}}" alt="Image">
                                    </div>
                                    <br>
                                    <br>
                            ...
                            <div class="form-group">
                                ...
                                <div class="thumb-preview" id="thumbPreview2">
                                    <img src="{{asset('assets/frontend/images/popups/' . $popup->background_image)}}" alt="Background Image">
                                </div>
                                <br>
                                <br>
