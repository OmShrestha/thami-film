                    ...
                    <tbody>
                      @foreach ($bcategorys as $key => $bcategory)
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm editbtn" href="#editModal" data-toggle="modal" data-bcategory_id="{{$bcategory->id}}" data-name="{{$bcategory->name}}" data-status="{{$bcategory->status}}" data-site_id="{{$bcategory->site_id}}" data-serial_number="{{$bcategory->serial_number}}">
