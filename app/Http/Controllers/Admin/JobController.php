...
class JobController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $in = $request->all();
        $in['slug'] = $slug;
        $in['job_responsibilities'] = str_replace(url('/') . '/assets/frontend/images/', "{base_url}/assets/frontend/images/", $request->job_responsibilities);
        $in['educational_requirements'] = str_replace(url('/') . '/assets/frontend/images/', "{base_url}/assets/frontend/images/", $request->educational_requirements);
        $in['experience_requirements'] = str_replace(url('/') . '/assets/frontend/images/', "{base_url}/assets/frontend/images/", $request->experience_requirements);
        $in['additional_requirements'] = str_replace(url('/') . '/assets/frontend/images/', "{base_url}/assets/frontend/images/", $request->additional_requirements);
        $in['salary'] = str_replace(url('/') . '/assets/frontend/images/', "{base_url}/assets/frontend/images/", $request->salary);
        $in['benefits'] = str_replace(url('/') . '/assets/frontend/images/', "{base_url}/assets/frontend/images/", $request->benefits);
        $in['read_before_apply'] = str_replace(url('/') . '/assets/frontend/images/', "{base_url}/assets/frontend/images/", $request->read_before_apply);
        Job::create($in);
