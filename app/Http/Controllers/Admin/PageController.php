...
class PageController extends Controller
{
    ...
    public function updateSettings(Request $request)
    {
        ...
        updateSettingsValue('custom_page_pagebuilder', $request->custom_page_pagebuilder);
    ...
    public function uploadPbImage(Request $request)
    {
        ...
        foreach ($files as $key => $file) {
            $directory = "assets/frontend/images/pagebuilder/";
    ...
    public function uploadPbTui(Request $request)
    {
        ...
        $path = 'assets/frontend/images/pagebuilder/' . $imageName;
