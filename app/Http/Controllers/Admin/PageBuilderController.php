...
class PageBuilderController extends Controller
{
    ...
    public function content(Request $request)
    {
        ...
        if ( $version == 'default' || $version == 'dark' || $version == 'news-portal' ) {
            $portfoliosLimit = 4;
        } elseif ($version == 'news-portal') {
            $portfoliosLimit = 3;
        } else {
            $portfoliosLimit = false;
        }

        if ( $version == 'news-portal' || $version == 'news-portal' ) {
            $membersLimit = 3;
        ...
        if ($version == 'lawyer') {
            $testimonialsLimit = 3;
        } elseif($version == 'default' || $version == 'dark' || $version == 'news-portal') {
            $testimonialsLimit = 2;
        } elseif ($version == 'gym') {
            $testimonialsLimit = 1;
        } else {
        ...
        if ( $version == 'default' || $version == 'dark' || $version == 'news-portal' || $version == 'news-portal' ) {
            $packagesLimit = 3;
        } else {
            $packagesLimit = false;
        }
        ...
        if ($version == 'default' || $version == 'dark') {
            ...
            $introsec = "<div class='pb-mb30'>
                <div class='container " . ($rtl == 1 ? 'pb-rtl' : '') . "'>
                    <div class='row'>
                        ...
                        <div class='intro-txt'>
                            <span class='section-title'>" . convertUtf8($this->bs->intro_section_title) . "</span>
                            <h2 class='section-summary'>" . convertUtf8($this->bs->intro_section_text) . " </h2>";
            if (!empty($this->bs->intro_section_button_url) && !empty($this->bs->intro_section_button_text)) {
                $introsec .= "<a href='" . $this->bs->intro_section_button_url . "' class='intro-btn' target='_blank'><span>" . convertUtf8($this->bs->intro_section_button_text) . "</span></a>";
            }
            $introsec .= "</div>
                        </div>
                        <div class='col-lg-6 " . ($rtl == 1 ? 'pr-lg-0' : 'pl-lg-0') . " px-md-3 px-0'>
                            <div class='intro-bg' style='background-image: url(" . url('assets/frontend/images/' . $this->bs->intro_bg) . ");background-size: cover;'>
                                <a id='play-video' class='video-play-button' href='" . $this->bs->intro_section_video_link . "'>
                                    <span></span>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class='row'>
                        <div class='col-lg-6'>
                            <div class='approach-summary'>
                                <span class='section-title'>" . convertUtf8($this->bs->approach_title) . "</span>
                                <h2 class='section-summary'>" . convertUtf8($this->bs->approach_subtitle) . "</h2>";
                                if (!empty($this->bs->approach_button_url) && !empty($this->bs->approach_button_text)) {
                                    $approachsec .= "<a href='" . $this->bs->approach_button_url . "' class='boxed-btn' target='_blank'><span>" . convertUtf8($this->bs->approach_button_text) . "</span></a>";
                                }
                            $approachsec .= "</div>
                        </div>
                        <div class='col-lg-6'>
                ...
                <div class='container " . ($rtl == 1 ? 'pb-rtl' : '') . "'>
                    <div class='service-categories'>
                        <div class='row justify-content-center text-center premade'>
                            <div class='col-lg-6'>
                                <span class='section-title'>" . convertUtf8($this->bs->service_section_title) . "</span>
                                <h2 class='section-summary'>" . convertUtf8($this->bs->service_section_subtitle) . "</h2>
                            </div>
                        </div>
                                ...
                                foreach ($scats as $key => $scategory) {
                                    ...
                                    if (!empty($scategory->image)) {
                                        $scatsec .= "<div class='img-wrapper'>
                                                                <img class='lazy' data-src='" . url("assets/frontend/images/service_category_icons/$scategory->image") . "' alt=''>
                                                            </div>";
                                    }
                                    $scatsec .= "<div class='text'>
                                                            ...
                                                            $scatsec .= "</p>
                                                            <a href='" . route('frontend.services', ['category' => $scategory->id]) . "' class='readmore'>" . __('View Services') . "</a>
                                                        </div>
                                                    </div>
                                                </div>";
                                }
                                ...
                                $servicesSec .= "<div class='col-lg-4 col-md-6 col-sm-8'>
                                        <div class='services-item mt-30'>
                                            <div class='services-thumb'>
                                                <img class='lazy' data-src='" . url('assets/frontend/images/services/' . $service->main_image) . "' alt='service' />
                                            </div>
                                            <div class='services-content'>
                                                <a class='title'";
                                                if ($service->details_page_status == 1) {
                                                    $servicesSec .= "href='" . route('frontend.serviceDetails', [$service->slug]) . "'";
                                                }
                                                ...
                                                $servicesSec .= "</p>";
                                                if ($service->details_page_status == 1) {
                                                    $servicesSec .= "<a href='" . route('frontend.serviceDetails', [$service->slug]) . "'>" . __('Read More') . " <i class='fas fa-plus'></i></a>";
                                                }
                                            $servicesSec .= "</div>
                                        </div>
                                    </div>";
            ...
            $portfoliosSec = "<div class='case-section pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "'>
                <div class='container'>
                    <div class='row justify-content-center text-center'>
                        <div class='col-lg-6'>
                            <span class='section-title'>" . convertUtf8($this->bs->portfolio_section_title) . "</span>
                            <h2 class='section-summary'>" . convertUtf8($this->bs->portfolio_section_text) . "</h2>
                        </div>
                    </div>
                </div>
                <div class='row' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable"]' . ">
                ...
                foreach ($portfolios as $key => $portfolio) {
                    $portfoliosSec .= "<div class='col-lg-3 mx-0 single-case single-case-bg-1 lazy' data-bg='" . url('assets/frontend/images/portfolios/featured/' . $portfolio->featured_image) . "'>
                    ...
                    $portfoliosSec .= "<a href='" . route('frontend.portfolioDetails', [$portfolio->slug]) . "' class='readmore-btn'><span>" . __('Read More') . "</span></a>;
            ...
            $teamSec = "<div class='team-section section-padding pb-mb30 lazy " . ($rtl == 1 ? 'pb-rtl' : '') . "' style='background-image: url(" . url('assets/frontend/images/' . $this->bs->team_bg) . ");background-size:cover;'>
                <div class='team-content'>
                <div class='container'>
                    <div class='row justify-content-center text-center'>
                        <div class='col-lg-6'>
                            <span class='section-title'>" . convertUtf8($this->bs->team_section_title) . "</span>
                            <h2 class='section-summary'>" . convertUtf8($this->bs->team_section_subtitle) . "</h2>
                        </div>
                    </div>
                    <team-section>
                        <div class='non-editable-area' data-gjs-stylable='false' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable","stylable"]' . ">
                ...
                foreach ($members as $key => $member) {
                    $teamSec .= "<div class='single-team-member col-lg-3 mx-0'>
                                <div class='team-img-wrapper'>
                                    <img class='lazy' data-src='" . url('assets/frontend/images/members/' . $member->image) . "' alt=''>
            ...
            $statisticSec = "<div class='statistics-section pb-mb30 lazy " . ($rtl == 1 ? 'pb-rtl' : '') . "' style='background-image: url(" . url('assets/frontend/images/' . $this->bs->statistics_bg) . ");background-size:cover;' id='statisticsSection'>
                            ...
                            <div class='non-editable-area' data-gjs-stylable='false' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable","stylable"]' . ">
                                ...
                                foreach ($statistics as $key => $statistic) {
                                    $statisticSec .= "<div class='col-lg-3 col-md-6'>
                                        <div class='round' data-value='1' data-number='" . convertUtf8($statistic->quantity) . "' data-size='200' data-thickness='6' data-fill='{&quot;color&quot;: &quot;#" . $this->bs->base_color . "&quot;}'>
                                        <strong></strong>
            ...
            $testimonialSec = "<div class='testimonial-section pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "'>
                <div class='container'>
                    <div class='row justify-content-center text-center'>
                        <div class='col-lg-6'>
                            <span class='section-title'>" . convertUtf8($this->bs->testimonial_title) . "</span>
                            <h2 class='section-summary'>" . convertUtf8($this->bs->testimonial_subtitle) . "</h2>
                        </div>
                    </div>
                    <div class='row' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable"]' . ">
                        <div class='col-md-12'>
                    ...
                    foreach ($testimonials as $key => $testimonial) {
                        $testimonialSec .= "<div class='single-testimonial col-6 mx-0'>
                                                <div class='img-wrapper'><img class='lazy' data-src='" . url('assets/frontend/images/testimonials/' . $testimonial->image) . "' alt=''></div>
            ...
            $packageSec = "<div class='pricing-tables pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "'>
                ...
                <div class='row justify-content-center text-center'>
                    <div class='col-lg-6'>
                        <span class='section-title'>" . convertUtf8($this->bs->pricing_title) . "</span>
                        <h2 class='section-summary'>" . convertUtf8($this->bs->pricing_subtitle) . "</h2>
                    </div>
                </div>
                <packages-section>
                    <div class='non-editable-area' data-gjs-stylable='false' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable","stylable"]' . ">
                    ...
                    foreach ($packages as $key => $package) {
                        ...
                        if ($package->order_status == 1) {
                            $packageSec .= "<a href='" . route('frontend.packageorder.index', $package->id) . "' class='pricing-btn'>" . __('Place Order') . "</a>";
                        }
            ...
            $blogSec = "<div class='blog-section section-padding pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "'>
                <div class='container'>
                    <div class='row justify-content-center text-center'>
                        <div class='col-lg-6'>
                            <span class='section-title'>" . convertUtf8($this->bs->blog_section_title) . "</span>
                            <h2 class='section-summary'>" . convertUtf8($this->bs->blog_section_subtitle) . "</h2>
                        </div>
                    </div>
                    <blogs-section>
                        <div class='non-editable-area' data-gjs-stylable='false' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable","stylable"]' . ">
                    ...
                    foreach ($blogs as $key => $blog) {
                        $blogSec .= "<div class='single-blog col-lg-4 mx-0'>
                                        <div class='blog-img-wrapper'>
                                            <img data-src='" . url('assets/frontend/images/blogs/' . $blog->main_image) . "' alt='' class='lazy'>
                                        </div>
                                        <div class='blog-txt'>";
                        ...
                        $blogSec .= "<p class='date'><small>" . __('By') .  " <span class='username'>" . __('Admin') . "</span></small> | <small>" . $blogDate . "</small> </p>
                                        ...
                                        <h4 class='blog-title'><a href='" . route('frontend.blogDetails', [$blog->slug]) . "'>" . (strlen($blog->title) > 40 ? mb_substr($blog->title, 0, 40, 'utf-8') . '...' : $blog->title) . "</a></h4>
                                        ...
                                        <a href='" . route('frontend.blogDetails', [$blog->slug]) . "' class='readmore-btn'><span>" . __('Read More') . "</span></a>
            ...
            $ctaSec = "<div class='cta-section pb-mb30 lazy " . ($rtl == 1 ? 'pb-rtl' : '') . "' style='background-image: url(" . url('assets/frontend/images/' . $this->bs->cta_bg) . "); background-size:cover;'>
                <div class='container'>
                    <div class='cta-content'>
                        <div class='row'>
                            <div class='col-md-9 col-lg-7'>
                                <h3>" . convertUtf8($this->bs->cta_section_text) . "</h3>
                            </div>
                            <div class='col-md-3 col-lg-5 contact-btn-wrapper'>
                                <a href='" . $this->bs->cta_section_button_url . "' class='boxed-btn contact-btn'><span>" . convertUtf8($this->bs->cta_section_button_text) . "</span></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            $partnerSec = "<div class='partner-section pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "'>
                <div class='container " . ($this->bs->theme_version != 'dark' ? 'top-border' : '') . "'>
                    <div class='row' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable"]' . ">
                        <div class='col-md-12'>
                            <partner-section>
                                <div class='non-editable-area' data-gjs-stylable='false' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable","stylable"]' . ">
                    ...
                    foreach ($partners as $key => $partner) {
                        $partnerSec .= "<a class='single-partner-item d-block col-lg-3 mx-0' href='" . $partner->url . "' target='_blank'>
                                                <div class='outer-container'>
                                                    <div class='inner-container'>
                                                        <img class='lazy' data-src='" . url('assets/frontend/images/partners/' . $partner->image) . "' alt=''>
                                                    </div>
                                                </div>
                                            </a>";
                    }
        ...
        if ($version == 'gym') {
                        ...
                        <div class='col-lg-6'>
                            <div class='finlance_box_img'>
                                <div class='finlance_img'>
                                    <img src='" . url('assets/frontend/images/' . $this->bs->intro_bg) . "' class='img-fluid' alt=''>
                                </div>
                                <div class='play_box'>
                                    <a href='" . $this->bs->intro_section_video_link . "' class='play_btn'><i class='fas fa-play'></i></a>
                                </div>
                            </div>
                        </div>
                        <div class='col-lg-6'>
                            <div class='finlance_content_box'>
                                <div class='section_title'>
                                    <span>" . convertUtf8($this->bs->intro_section_title) . "</span>
                                    <h2>" . convertUtf8($this->bs->intro_section_text) . "</h2>
                                    <span class='line-circle'></span>
                                </div>";
            if (!empty($this->bs->intro_section_button_url) && !empty($this->bs->intro_section_button_text)) {
                $introsec .= "<div class='button_box'>
                                        <a href='" . $this->bs->intro_section_button_url . "' class='finlance_btn' target='_blank'>" . convertUtf8($this->bs->intro_section_button_text) . "</a>
                                    </div>";
            }
            $introsec .= "</div>
                        </div>
                ...
                <div class='container'>
                    <div class='row'>
                        <div class='col-lg-6'>
                            <div class='finlance_content_box'>
                                <div class='section_title'>
                                    <span>" . convertUtf8($this->bs->approach_title) . "</span>
                                    <h2>" . convertUtf8($this->bs->approach_subtitle) . "</h2>
                                    <span class='line-circle'></span>
                                </div>";
            if (!empty($this->bs->approach_button_url) && !empty($this->bs->approach_button_text)) {
                $approachsec .= "<div class='button_box'>
                                        <a href='" . $this->bs->approach_button_url . "' class='finlance_btn'>" . convertUtf8($this->bs->approach_button_text) . "</a>
                                    </div>";
            }
            $approachsec .= "</div>
                        </div>
                    ...
                    <div class='row justify-content-center'>
                        <div class='col-lg-6'>
                            <div class='section_title text-center'>
                                <span>" . convertUtf8($this->bs->service_section_title) . "</span>
                                <h2>" . convertUtf8($this->bs->service_section_subtitle) . "</h2>
                            </div>
                        </div>
                    </div>
                    <service-category-section>
                    ...
                    foreach ($scats as $key => $scat) {
                        ...
                        if (!empty($scat->image)) {
                            $scatsec .= "<div class='finlance_img'>
                                                    <img data-src='" . url('assets/frontend/images/service_category_icons/' . $scat->image) . "' class='img-fluid lazy' alt=''>
                                                    <div class='service_overlay'>
                                                        <div class='button_box'>
                                                            <a href='" . route('frontend.services', ['category' => $scat->id]) . "' class='more_icon'><i class='fas fa-angle-double-right'></i></a>
                                                        </div>
                                                    </div>
                                                </div>";
                        }
                        $scatsec .= "<div class='finlance_content'>
                                                <h3><a href='" . route('frontend.services', ['category' => $scat->id]) . "'>" . convertUtf8($scat->name) . "</a></h3>
                                            </div>
                        ...
                        if (!empty($service->main_image)) {
                            ...
                            if ($service->details_page_status == 1) {
                                $servicesSec .= "<div class='service_overlay'>
                                                            <div class='button_box'>
                                                                <a href='" . route('frontend.serviceDetails', [$service->slug]) . "' class='more_icon'><i class='fas fa-angle-double-right'></i></a>
                                                            </div>
                                                        </div>";
                            }
                            $servicesSec .= "</div>";
            ...
            $portfoliosSec = "<section class='finlance_project project_v1 pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "' style='padding-bottom: 60px;'>
                <div class='container-full'>
                    <div class='row justify-content-center'>
                        <div class='col-lg-6'>
                            <div class='section_title text-center'>
                                <span>" . convertUtf8($this->bs->portfolio_section_title) . "</span>
                                <h2>" . convertUtf8($this->bs->portfolio_section_text) . "</h2>
                            </div>
                        </div>
                    </div>
                    <portfolios-section>
                    ...
                    foreach ($portfolios as $key => $portfolio) {
                        $portfoliosSec .= "<div class='grid_item col-3 px-0 mx-0'>
                                        <div class='grid_inner_item'>
                                            <div class='finlance_img'>
                                                <img data-src='" . url('assets/frontend/images/portfolios/featured/' . $portfolio->featured_image) . "' class='img-fluid lazy' alt=''>
                                                <div class='project_overlay'>
                                                    <div class='finlance_content'>
                                                        <a href='" . route('frontend.portfolioDetails', [$portfolio->slug]) . "' class='more_icon'><i class='fas fa-angle-double-right'></i></a>
                                                        <h3><a href='" . route('frontend.portfolioDetails', [$portfolio->slug]) . "'>" . (strlen($portfolio->title) > 36 ? mb_substr($portfolio->title, 0, 36, 'utf-8') . '...' : $portfolio->title) . "</a></h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            $teamSec = "<section class='finlance_team team_v1 gray_bg pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "'>
                <div class='container'>
                    <div class='row justify-content-center'>
                        <div class='col-lg-6'>
                            <div class='section_title text-center'>
                                <span>" . convertUtf8($this->bs->team_section_title) . "</span>
                                <h2>" . convertUtf8($this->bs->team_section_subtitle) . "</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    foreach ($members as $key => $member) {
                        $teamSec .= "<div class='grid_item col-4 mx-0'>
                                        <div class='grid_inner_item'>
                                            <div class='finlance_img'>
                                                <img data-src='" . url('assets/frontend/images/members/' . $member->image) . "' class='img-fluid lazy' alt=''>
            ...
            $statisticSec = "<section class='finlance_fun finlance_fun_v1 bg_image pb-mb30 lazy " . ($rtl == 1 ? 'pb-rtl' : '') . "' style='background-image: url(" . url('assets/frontend/images/' . $this->bs->statistics_bg) . ");background-size:cover; padding: 100px 0px;' id='statisticsSection'>
            ...
            $testimonialSec = "<section class='finlance_testimonial testimonial_v1 pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "'>
                <div class='container'>
                    <div class='row justify-content-center'>
                        <div class='col-lg-6'>
                            <div class='section_title text-center'>
                                <span>" . convertUtf8($this->bs->testimonial_title) . "</span>
                                <h2>" . convertUtf8($this->bs->testimonial_subtitle) . "</h2>
                            </div>
                        </div>
                    </div>
                    <testimonial-section>
                        ...
                        $testimonialSec .= "<div class='testimonial_box col-12 mx-0'>
                                        <div class='row align-items-center'>
                                            <div class='col-lg-5 col-md-5'>
                                                <div class='finlance_img'>
                                                    <img data-src='" . url('assets/frontend/images/testimonials/' . $testimonial->image) . "' class='img-fluid lazy' alt=''>
                                                </div>
                                            </div>
                                            <div class='col-lg-7 col-md-7'>
                                                <div class='finlance_content'>
                                                    <img class='lazy' data-src='" . url('assets/frontend/images/quote.png') . "' alt=''>
            ...
            $packageSec = "<section class='logistics_pricing pricing_v1 pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "'>
                <div class='container'>
                    <div class='row justify-content-center'>
                        <div class='col-lg-6'>
                            <div class='section_title text-center'>
                                <span>" . convertUtf8($this->bs->pricing_title) . "</span>
                                <h2>" . convertUtf8($this->bs->pricing_subtitle) . "</h2>
                            </div>
                        </div>
                    </div>
                    <packages-section>
                    ...
                    foreach ($packages as $key => $package) {
                        ...
                        if ($package->order_status == 1) {
                            $packageSec .= "<a href='" . route('frontend.packageorder.index', $package->id) . "' class='finlance_btn'>" . __('Place Order') . "</a>";
                        }
                        $packageSec .= "</div>
                                    </div>";
                    }
            ...
            $blogSec = "<section class='finlance_blog blog_v1 pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "'>
                <div class='container'>
                    <div class='row'>
                        <div class='col-lg-6'>
                            <div class='section_title'>
                                <span>" . convertUtf8($this->bs->blog_section_title) . "</span>
                                <h2>" . convertUtf8($this->bs->blog_section_subtitle) . "</h2>
                                <span class='line-circle'></span>
                            </div>
                        </div>
                    </div>
                    ...
                    foreach ($blogs as $key => $blog) {
                        $blogSec .= "<div class='grid_item col-4 mx-0'>
                            <div class='grid_inner_item'>
                                <div class='finlance_img'>
                                    <a href='" . route('frontend.blogDetails', [$blog->slug]) . "'><img data-src='" . url('assets/frontend/images/blogs/' . $blog->main_image) . "' class='img-fluid lazy' alt=''></a>
            ...
            $blogSec .= "<div class='post_meta'>
                                            ...
                                            <h3 class='post_title'><a href='" . route('frontend.blogDetails', [$blog->slug]) . "'>" . (strlen($blog->title) > 40 ? mb_substr($blog->title, 0, 40, 'utf-8') . '...' : $blog->title) . "</a></h3>
                                            <p>" . (strlen(strip_tags($blog->content)) > 100 ? mb_substr(strip_tags($blog->content), 0, 100, 'utf-8') . '...' : strip_tags($blog->content)) . "</p>
                                            <a href='" . route('frontend.blogDetails', [$blog->slug]) . "' class='btn_link'>" . __('Read More') . "</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            $ctaSec = "<section class='finlance_cta cta_v1 main_bg pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "' style='padding: 70px 0px;'>
                <div class='container'>
                    <div class='row align-items-center'>
                        <div class='col-lg-8'>
                            <div class='section_title'>
                                <h2 class='text-white'>" . convertUtf8($this->bs->cta_section_text) . "</h2>
                            </div>
                        </div>
                        <div class='col-lg-4'>
                            <div class='button_box'>
                                <a href='" . $this->bs->cta_section_button_url . "' class='finlance_btn'>" . convertUtf8($this->bs->cta_section_button_text) . "</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class='non-editable-area' data-gjs-stylable='false' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable","stylable"]' . ">
                            ...
                            foreach ($partners as $key => $partner) {
                                $partnerSec .= "<div class='single_partner col-3 mx-0'>
                                    <a href='" . $partner->url . "' target='_blank'><img data-src='" . url('assets/frontend/images/partners/' . $partner->image) . "' class='img-fluid lazy' alt=''></a>
                                </div>";
                            }
                            $partnerSec .= "</div>
                        </div>
        ...
        if ($version == 'news-portal') {
            ...
            $introsec = "<section class='finlance_about about_v1 bg_image pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "' style='background-image: url(" . url('assets/frontend/images/' . $this->bs->intro_bg) . ");background-size: cover;padding: 120px 0px;'>
                <div class='container'>
                    <div class='row align-items-center'>
                        <div class='col-lg-4'>
            ...
            if (!empty($this->bs->intro_section_button_url) && !empty($this->bs->intro_section_button_text)) {
                $introsec .= "<div class='button_box'>
                                        <a href='" . $this->bs->intro_section_button_url . "' class='finlance_btn'>" . convertUtf8($this->bs->intro_section_button_text) . "</a>
                                    </div>";
            }
            $introsec .= "</div>
                        </div>
                        ...
                        <div class='non-editable-area' data-gjs-stylable='false' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable","stylable"]' . ">
                            ...
                            foreach ($scats as $key => $scat) {
                                ...
                                $scatsec .= "<div class='finlance_content'>
                                                    ...
                                                    $scatsec .= "</p>
                                                            <a href='" . route('frontend.services', ['category' => $scat->id]) . "' class='btn_link'>" . __('View Services') . "</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>";
                ...
                <div class='container'>
                    ...
                    foreach ($services as $key => $service) {
                        ...
                        $servicesSec .= "<div class='finlance_content'>
                                                    ...
                                                    $servicesSec .= "</p>";
                        if ($service->details_page_status == 1) {
                            $servicesSec .= "<a href='" . route('frontend.serviceDetails', [$service->slug]) . "' class='btn_link'>" . __('Read More') . "</a>";
                        }
                        $servicesSec .= "</div>
                                            </div>
                                        </div>
                                            ...
                                            <div class='finlance_img'>
                                                ...
                                                <div class='project_overlay'>
                                                    <div class='finlance_content'>
                                                        ...
                                                        <h3><a href='" . route('frontend.portfolioDetails', [$portfolio->slug]) . "'>" . (strlen($portfolio->title) > 25 ? mb_substr($portfolio->title, 0, 25, 'utf-8') . '...' : $portfolio->title) . "</a></h3>";
                ...
                <div class='container'>
                    ...
                    foreach ($members as $key => $member) {
                        ...
                        $teamSec .= "</ul>
                                            ...
                                            <div class='finlance_content lazy' data-bg='" . url('assets/frontend/images/pattern_bg.jpg') . "'>
            ...
            $statisticSec = "<section class='finlance_fun finlance_fun_v1 pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "' style='background-image: url(" . url('assets/frontend/images/pattern_bg_2.jpg') . ");padding: 100px 0px;'>
                <div class='container'>
                    <statistics-section>
                        <div class='non-editable-area' data-gjs-stylable='false' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable","stylable"]' . ">
                            <div class='non-editable-notice'>
                            ...
                            foreach ($testimonials as $key => $testimonial) {
                                $testimonialSec .= "<div class='testimonial_box'>
                                    ...
                                    <div class='client_box'>
                                        <div class='thumb'>
                                            <img class='lazy' data-src='" . url('assets/frontend/images/testimonials/' . $testimonial->image) . "' alt=''>
                                        </div>
                                        <div class='info'>
                                            <h3>" . convertUtf8($testimonial->name) . "</h3>
                                            <h6>" . convertUtf8($testimonial->rank) . "</h6>
            ...
            $packageSec = "<section class='finlance_pricing pricing_v1 pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "'>
                <div class='pricing-bg' style='background-image: url(" . url('assets/frontend/images/' . $this->bs->package_background) . "); background-size: cover;'>
                </div>
                <div class='container'>
                    <div class='row justify-content-center'>
                        <div class='col-lg-6'>
                ...
                <div class='container'>
                    ...
                    foreach ($blogs as $key => $blog) {
                        ...
                        $blogSec .= "<div class='post_meta'>
                                                        ...
                                                        <h3 class='post_title'><a href='" . route('frontend.blogDetails', [$blog->slug]) . "'>" . (strlen($blog->title) > 40 ? mb_substr($blog->title, 0, 40, 'utf-8') . '...' : $blog->title) . "</a></h3>
                                                        <p>" . (strlen(strip_tags($blog->content)) > 100 ? mb_substr(strip_tags($blog->content), 0, 100, 'utf-8') . '...' : strip_tags($blog->content)) . "</p>
                                                        <a href='" . route('frontend.blogDetails', [$blog->slug]) . "' class='finlance_btn'>" . __('Read More') . "</a>
                                                    </div>
                                                </div>
                                                <div class='col-lg-6'>
                                                    <div class='finlance_img'>
                                                        <a href='" . route('frontend.blogDetails', [$blog->slug]) . "'><img data-src='" . url('assets/frontend/images/blogs/' . $blog->main_image) . "' class='img-fluid lazy' alt='' width='100%'></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            $ctaSec = "<section class='finlance_cta cta_v1 pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "' style='background-image: url(" . url('assets/frontend/images/pattern_bg_2.jpg') . "); background-size: cover; padding: 70px 0px;'>
                <div class='container'>
                    <div class='row align-items-center'>
                        <div class='col-lg-8'>
                            <div class='section_title'>
                                <h2>" . convertUtf8($this->bs->cta_section_text) . "</h2>
                            </div>
                        </div>
                        <div class='col-lg-4'>
                            <div class='button_box'>
        ...
        if ($version == 'cleaning') {
                        ...
                        <div class='row justify-content-center'>
                            <div class='col-lg-8'>
                                <div class='section-title-one text-center'>
                                    <span>" . convertUtf8($this->bs->intro_section_title) . "</span>
                                    <h1>" . convertUtf8($this->bs->intro_section_text) . "</h1>
                                </div>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='col-lg-12'>
                                <div class='video-content' style='background-image: url(" . url('assets/frontend/images/' . $this->bs->intro_bg) . "); background-size:cover;'>
                                    <a href='" . $this->bs->intro_section_video_link . "' class='play-btn video-popup'><i class='fa fa-play'></i></a>
                                </div>";
            if (!empty($this->bs->intro_section_button_url) && !empty($this->bs->intro_section_button_text)) {
                $introsec .= "<div class='video-btn-area'>
                                    <a href='" . $this->bs->intro_section_button_url . "' class='main-btn video-btn' target='_blank'>" . convertUtf8($this->bs->intro_section_button_text) . "</a>
                                </div>";
            }
            $introsec .= "</div>
                        </div>
                    ...
                    <div class='row'>
                        <div class='col-lg-6'>
                            <div class='section-title-two'>
                                <span>" . convertUtf8($this->bs->approach_title) . "</span>
                                <h1>" . convertUtf8($this->bs->approach_subtitle) . "</h1>
                            </div>";
            if (!empty($this->bs->approach_button_url) && !empty($this->bs->approach_button_text)) {
                $approachsec .= "<div class='button_box'>
                                    <a href='" . $this->bs->approach_button_url . "' class='main-btn about-btn'>" . convertUtf8($this->bs->approach_button_text) . "</a>
                                </div>";
            }
            $approachsec .= "</div>
                        <div class='col-lg-6'>
                ...
                <div class='container'>
                    <div class='row justify-content-center'>
                        <div class='col-lg-8'>
                            <div class='section-title-one text-center'>
                                <span>" . convertUtf8($this->bs->service_section_title) . "</span>
                                <h1>" . convertUtf8($this->bs->service_section_subtitle) . "</h1>
                            </div>
                        </div>
                    </div>
                    <service-category-section>
                        ...
                        if (!empty($scat->image)) {
                            $scatsec .= "<div class='single-service-bg'>
                                                ...
                                                <div class='single-service-link'>
                                                    <a href='" . route('frontend.services', ['category' => $scat->id]) . "' class='main-btn service-btn'>" . __('View Services') . "</a>
                                                </div>
                                            </div>
                    ...
                    foreach ($services as $key => $service) {
                        ...
                        if (!empty($service->main_image)) {
                            $servicesSec .= "<div class='single-service-bg'>
                                                    <img class='lazy' data-src='" . url('assets/frontend/images/services/' . $service->main_image) . "' alt=''>
                                                    <span><i class='fas fa-quidditch'></i></span>";
                            if ($service->details_page_status == 1) {
                                $servicesSec .= "<div class='single-service-link'>
                                                            <a href='" . route('frontend.serviceDetails', [$service->slug]) . "' class='main-btn service-btn'>" . __('View More') . "</a>
                                                        </div>";
                            }
                            $servicesSec .= "</div>
                                                <div class='single-service-content'>
                ...
                <div class='container'>
                    <div class='row'>
                        <div class='col-lg-8'>
                            <div class='section-title-two'>
                                <span>" . convertUtf8($this->bs->portfolio_section_title) . "</span>
                                <h1>" . convertUtf8($this->bs->portfolio_section_text) . "</h1>
                            </div>
                        </div>
                        <div class='col-lg-4 text-right'>
                            <a href='" . route('frontend.portfolios') . "' class='project-btn'>" . __('View More') . " <i class='fa fa-arrow-right'></i></a>
                        </div>
                    </div>
                </div>
                <div class='container-fluid'>
                    ...
                    foreach ($portfolios as $key => $portfolio) {
                        $portfoliosSec .= "<div class='single-project-item col-3 mx-0'>
                                        <img class='lazy' data-src='" . url('assets/frontend/images/portfolios/featured/' . $portfolio->featured_image) . "' alt=''>
                        ...
                        $portfoliosSec .= "<a href='" . route('frontend.portfolioDetails', [$portfolio->slug]) . "' class='main-btn project-link-btn'>" . __('View Details') . "</a>
                                        </div>
                                    </div>";
                    }
                    $portfoliosSec .= "</div>
                ...
                <div class='container'>
                    <div class='row justify-content-center'>
                        <div class='col-lg-8'>
                            <div class='section-title-one text-center'>
                                <span>" . convertUtf8($this->bs->team_section_title) . "</span>
                                <h1>" . convertUtf8($this->bs->team_section_subtitle) . "</h1>
                            </div>
                        </div>
                    </div>
                    <team-section>
            ...
            $statisticSec = "<section class='project-counter-area pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "' style='background-image: url(" . url('assets/frontend/images/' . $this->bs->statistics_bg) . "); background-size: cover; padding: 100px 0px;'>
                <div class='container'>
                    <statistics-section>
                        <div class='non-editable-area' data-gjs-stylable='false' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable","stylable"]' . ">
                            <div class='non-editable-notice'>
                ...
                <div class='container'>
                    <div class='row justify-content-center'>
                        <div class='col-lg-8'>
                            <div class='section-title-one text-center'>
                                <span>" . convertUtf8($this->bs->testimonial_title) . "</span>
                                <h1>" . convertUtf8($this->bs->testimonial_subtitle) . "</h1>
                            </div>
                        </div>
                    </div>
                    <testimonial-section>
                ...
                <div class='container'>
                    <div class='row justify-content-center'>
                        <div class='col-lg-8'>
                            <div class='section-title-one text-center'>
                                <span>" . convertUtf8($this->bs->pricing_title) . "</span>
                                <h1>" . convertUtf8($this->bs->pricing_subtitle) . "</h1>
                            </div>
                        </div>
                    </div>
                    <packages-section>
                    ...
                    foreach ($packages as $key => $package) {
                        ...
                        if ($package->order_status == 1) {
                            $packageSec .= "<a href='" . route('frontend.packageorder.index', $package->id) . "' class='main-btn price-btn'>" . __('Place Order') . "</a>";
                        }
                        $packageSec .= "</div>";
                    }
                    $packageSec .= "</div>
                ...
                <div class='container'>
                    <div class='row'>
                        <div class='col-lg-7'>
                            <div class='section-title-two'>
                                <span>" . convertUtf8($this->bs->blog_section_title) . "</span>
                                <h1>" . convertUtf8($this->bs->blog_section_subtitle) . "</h1>
                            </div>
                        </div>
                        <div class='col-lg-5 text-right'>
                            <a href='" . route('frontend.blogs.index') . "' class='blog-link'>" . __('View More') . " <i class='fa fa-arrow-right'></i></a>
                        </div>
                    </div>
                    <blogs-section>
                        <div class='non-editable-area' data-gjs-stylable='false' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable","stylable"]' . ">
                    ...
                    foreach ($blogs as $key => $blog) {
                        ...
                        $blogSec .= "<div class='single-blog-item col-4 mx-0'>
                                        <div class='single-blog-img'>
                                            <img class='lazy' data-src='" . url('assets/frontend/images/blogs/' . $blog->main_image) . "' alt=''>
                                        </div>
                        ...
                        $blogSec .= "<span><i class='fa fa-arrow-right'></i>" . __('By') . " " . __('Admin') . "</span>
                                            ...
                                            <p>" . (strlen(strip_tags($blog->content)) > 100 ? mb_substr(strip_tags($blog->content), 0, 100, 'utf-8') . '...' : strip_tags($blog->content)) . "</p>
                                            <a href='" . route('frontend.blogDetails', [$blog->slug]) . "' class='blog-btn'>" . __('Read More') . " <i class='fa fa-arrow-right'></i></a>
                                        </div>
                                    </div>";
                    }
                    $blogSec .= "</div>
            ...
            $ctaSec = "<section class='cta-area pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "' style='background-image: url(" . url('assets/frontend/images/' . $this->bs->cta_bg) . "); background-size:cover;'>
                <div class='container'>
                    <div class='row align-items-center'>
                        <div class='col-lg-8'>
                            <h1>" . convertUtf8($this->bs->cta_section_text) . "</h1>
                        </div>
                        <div class='col-lg-4 text-center'>
                            <a href='" . $this->bs->cta_section_button_url . "' class='main-btn cta-btn'>" . convertUtf8($this->bs->cta_section_button_text) . "</a>
                        </div>
                    </div>
                </div>
            </section>";
                                ...
                                <div class='col-lg-12'>
                                    ...
                                    foreach ($partners as $key => $partner) {
                                        $partnerSec .= "<div class='single-brand-logo col-3 mx-0'>
                                            <a class='d-block' href='" . $partner->url . "' target='_blank'><img data-src='" . url('assets/frontend/images/partners/' . $partner->image) . "' class='img-fluid lazy' alt=''></a>
                                        </div>";
                                    }
                                    $partnerSec .= "</div>
                                </div>
                        ...
                        $scatsec .= "<div class='grid_item col-4 mx-0'>
                                        <div class='grid_inner_item'>
                                            ...
                                            <div class='finlance_content'>
                                                ...
                                                $scatsec .= "</p>
                                                <a href='" . route('frontend.services', ['category' => $scat->id]) . "' class='btn_link d-inline-block mt-35'>" . __('View Services') . "</a>
                                            </div>
                                        </div>
                                    </div>";
                    }
                            ...
                            foreach ($services as $key => $service) {
                                $servicesSec .= "<div class='grid_item col-4 mx-0'>
                                    ...
                                    $servicesSec .= "<div class='finlance_content'>
                                        ...
                                        $servicesSec .= "</p>";
                                    if ($service->details_page_status == 1) {
                                        $servicesSec .= "<a href='" . route('frontend.serviceDetails', [$service->slug]) . "' class='btn_link d-inline-block mt-35'>" . __('Read More') . "</a>";
                                    }
                                    $servicesSec .= "</div>
                                    </div>
                                </div>";
                                        ...
                                        <div class='grid_inner_item'>
                                            <div class='finlance_img'>
                                                ...
                                                <div class='overlay_content'>
                                                    <div class='button_box'>
                                                        <a href='" . route('frontend.portfolioDetails', [$portfolio->slug]) . "' class='finlance_btn'>" . __('View More') . "</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class='finlance_content'>
...
//                        <div class='col-lg-4'>
//                            <div class='button_box'>
//                                <a href='" . route('frontend.teams.index') . "' class='btn_link'>" . __('View More') . "</a>
//                            </div>
//                        </div>
//                    </div>
//                    <team-section>
...
//            </section>";
            ...
            $statisticSec = "<section class='finlance_fun finlance_fun_v1 bg_image pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "' style='background-image: url(" . url('assets/frontend/images/' . $this->bs->statistics_bg) . ");background-size:cover; padding: 100px 0px;' id='statisticsSection'>
                ...
                <div class='container'>
                    <partner-section>
                        <div class='non-editable-area' data-gjs-stylable='false' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable","stylable"]' . ">
                            ...
                            foreach ($partners as $key => $partner) {
                                $partnerSec .= "<div class='single_partner col-3 mx-0'>
                                                <a href='" . $partner->url . "'><img data-src='" . url('assets/frontend/images/partners/' . $partner->image) . "' class='img-fluid lazy' alt=''></a>
                                            </div>";
                            }
                            $partnerSec .= "</div>
                        </div>
        ...
        if ($version == 'logistic') {
                    ...
                    <div class='row align-items-center'>
                        <div class='col-lg-6'>
                            <div class='logistics_box_img'>
                                ...
                                <div class='logistics_img'>
                                    <img src='" . url('assets/frontend/images/' . $this->bs->intro_bg2) . "' class='img-fluid' alt=''>
                                    <div class='play_box'>
                                        <a href='" . $this->bs->intro_section_video_link . "' class='play_btn'><i class='fas fa-play'></i></a>
                                    </div>
                                </div>
                        ...
                        <div class='col-lg-6'>
                            <div class='logistics_content_box'>
                                ...
                                <div class='button_box'>
                                    <a href='" . $this->bs->intro_section_button_url . "' class='logistics_btn'>" . convertUtf8($this->bs->intro_section_button_text) . "</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            if (!empty($this->bs->approach_button_url) && !empty($this->bs->approach_button_text)) {
                $approachsec .= "<div class='button_box'>
                                        <a href='" . $this->bs->approach_button_url . "' class='logistics_btn'>" . convertUtf8($this->bs->approach_button_text) . "</a>
                                    </div>";
            }
            $approachsec .= "</div>
                        </div>
                            ...
                            foreach ($services as $key => $service) {
                                ...
                                if (!empty($service->main_image)) {
                                    $servicesSec .= "<div class='logistics_icon'>
                                                            <img data-src='" . url('assets/frontend/images/services/' . $service->main_image) . "' class='img-fluid lazy' alt=''>
                                                        </div>";
                                }
                                ...
                                if ($service->details_page_status == 1) {
                                    $servicesSec .= "<a href='" . route('frontend.serviceDetails', [$service->slug]) . "' class='btn_link'>" . __('View Services') . "</a>";
                                }
                        ...
                        $portfoliosSec .= "<div class='grid_item col-3 mx-0'>
                                        <div class='grid_inner_item'>
                                            <div class='logistics_img'>
                                                ...
                                                <div class='overlay_content'>
                                                    <div class='button_box'>
                                                        <a href='" . route('frontend.portfolioDetails', [$portfolio->slug]) . "' class='logistics_btn'>" . __('View More') . "</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class='logistics_content'>
            ...
            $teamSec = "<section class='logistics_team team_v1 gray_bg pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "'>
                <div class='container'>
                    <div class='row align-items-center'>
                        ...
                        <div class='col-lg-4'>
                            <div class='button_box'>
                                <a href='" . route('frontend.team') . "' class='btn_link'>" . __('View More') . "</a>
                            </div>
                        </div>
                    </div>
                    <team-section>
            ...
            $statisticSec = "<section class='logistics_fun logistics_fun_v1 bg_image pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "' style='background-image: url(" . url('assets/frontend/images/' . $this->bs->statistics_bg) . ");background-size:cover; padding: 100px 0px;' id='statisticsSection'>
                <div class='container' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable"]' . ">
                    <statistics-section>
                        <div class='non-editable-area' data-gjs-stylable='false' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable","stylable"]' . ">
                            <div class='non-editable-notice'>
                ...
                <div class='container'>
                    ...
                    foreach ($testimonials as $key => $testimonial) {
                        $testimonialSec .= "<div class='testimonial_box d-lg-flex align-items-lg-center'>
                                        <div class='logistics_img'>
                                            <img data-src='" . url('assets/frontend/images/testimonials/' . $testimonial->image) . "' class='img-fluid lazy' alt='' width='100%'>
                                        </div>
                                        <div class='logistics_content'>
                                            <h4>" . convertUtf8($testimonial->name) . "</h4>
                                            <h6>" . convertUtf8($testimonial->rank) . "</h6>
                ...
                <div class='container'>
                    ...
                    foreach ($packages as $key => $package) {
                        $packageSec .= "<div class='pricing_box text-center col-4 mx-0'>
                                        ...
                                        <div class='pricing_button'>";
                        if ($package->order_status == 1) {
                            $packageSec .= "<a href='" . route('frontend.packageorder.index', $package->id) . "' class='logistics_btn'>" . __('Place Order') . "</a>";
                        }
                        $packageSec .= "</div>
                                    </div>";
                    }
                ...
                <div class='container'>
                    ...
                    foreach ($blogs as $key => $blog) {
                        ...
                        $blogSec .= "<span><i class='far fa-user'></i><a href='#'>" . __('By') . " " . __('Admin') . "</a></span>
                                                ...
                                                <h3 class='post_title'><a href='" . route('frontend.blogDetails', [$blog->slug]) . "'>" . (strlen($blog->title) > 40 ? substr($blog->title, 0, 40) . '...' : $blog->title) . "</a></h3>
                                                <a href='" . route('frontend.blogDetails', [$blog->slug]) . "' class='btn_link'>" . __('Read More') . "</a>
                                            </div>
                                        </div>
                                    </div>";
            ...
            $ctaSec = "<section class='logistics_cta cta_v1 main_bg pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "' style='padding: 70px 0px;'>
                <div class='container'>
                    <div class='row align-items-center'>
                        ...
                        <div class='col-lg-3'>
                            <div class='button_box'>
                                <a href='" . $this->bs->cta_section_button_url . "' class='logistics_btn'>" . convertUtf8($this->bs->cta_section_button_text) . "</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        if ($version == 'lawyer') {
                    ...
                    <div class='row align-items-center'>
                        ...
                        <div class='col-lg-5'>
                            <div class='lawyer_content_box'>
                                ...
                                <div class='button_box'>
                                    <a href='" . $this->bs->intro_section_button_url . "' class='lawyer_btn'>" . convertUtf8($this->bs->intro_section_button_text) . "</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            if (!empty($this->bs->approach_button_url) && !empty($this->bs->approach_button_text)) {
                $approachsec .= "<div class='button_box  wow fadeInUp' data-wow-delay='.4s'>
                                        <a href='" . $this->bs->approach_button_url . "' class='lawyer_btn'>" . convertUtf8($this->bs->approach_button_text) . "</a>
                                    </div>";
            }
            $approachsec .= "</div>
                        </div>
                                        ...
                                        $scatsec .= "<div class='grid_item col-lg-4 mx-0'>
                                            <div class='grid_inner_item'>
                                                ...
                                                <div class='lawyer_content'>
                                                    ...
                                                    $scatsec .= "</p>
                                                    <a href='" . route('frontend.services', ['category' => $scat->id]) . "' class='lawyer_btn'>" . __('View Services') . "</a>
                                                </div>
                                            </div>
                                        </div>";
                                    }
                    ...
                    foreach ($services as $key => $service) {
                        ...
                        $servicesSec .= "</div>
                                            <div class='lawyer_content'>
                                                ...
                                                $servicesSec .= "</p>";
                        if ($service->details_page_status == 1) {
                            $servicesSec .= "<a href='" . route('frontend.serviceDetails', [$service->slug]) . "' class='lawyer_btn'>" . __('Read More') . "</a>";
                        }
                        $servicesSec .= "</div>
                                        </div>
                                    </div>";
            ...
            $portfoliosSec = "<section class='lawyer_project project_v1 pb-mb30 " . ($rtl == 1 ? 'pb-rtl' : '') . "'>
                ...
                <div class='container-fluid'>
                    ...
                    foreach ($portfolios as $key => $portfolio) {
                        ...
                        $portfoliosSec .= "<a href='" . route('frontend.portfolioDetails', [$portfolio->slug]) . "' class='lawyer_btn'>" . __('View More') . "</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>";
            ...
            $statisticSec = "<section class='lawyer_fun lawyer_fun_v1 bg_image pb-mb30 lazy " . ($rtl == 1 ? 'pb-rtl' : '') . "' style='background-image: url(" . url('assets/frontend/images/' . $this->bs->statistics_bg) . "); background-size:cover; padding: 100px 0px;' id='statisticsSection'>
                <div class='container'>
                    <statistics-section>
                        <div class='non-editable-area' data-gjs-stylable='false' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable","stylable"]' . ">
                            <div class='non-editable-notice'>
                        ...
                        <div class='non-editable-area' data-gjs-stylable='false' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable","stylable"]' . ">
                            ...
                            foreach ($testimonials as $key => $testimonial) {
                                $testimonialSec .= "<div class='testimonial_box col-lg-4 mx-0' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable"]' . ">
                                    <div class='lawyer_content_box'>
                                        <img class='lazy' data-src='" . url('assets/frontend/images/quote_1.png') . "' alt=''>
                                        <p>" . convertUtf8($testimonial->comment) . "</p>
                        ...
                        <div class='non-editable-area' data-gjs-stylable='false' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable","stylable"]' . ">
                            ...
                            foreach ($packages as $key => $package) {
                                ...
                                if (!empty($package->image)) {
                                    $packageSec .= "<img class='lazy' data-src='" . url('assets/frontend/images/packages/' . $package->image) . "' alt=''>";
                                }
                                ...
                                <div class='pricing_button'>";
                                if ($package->order_status == 1) {
                                    $packageSec .= "<a href='" . route('frontend.packageorder.index', $package->id) . "' class='lawyer_btn'>" . __('Place Order') . "</a>";
                                }
                                $packageSec .= "</div>
                                </div>";
                            }
                    ...
                    <div class='row align-items-center'>
                        ...
                        <div class='col-lg-6'>
                            <div class='button_box float-lg-right'>
                                <a href='" . route('frontend.blogs.index') . "' class='btn_link'>" . __('View More') . "</a>
                            </div>
                        </div>
                    </div>
                    <blogs-section>
            ...
            $ctaSec = "<section class='lawyer_cta cta_v1 bg_image pb-mb30 lazy " . ($rtl == 1 ? 'pb-rtl' : '') . "' style='background-image: url(" . url('assets/frontend/images/' . $this->bs->cta_bg) . "); background-size:cover; padding: 70px 0px;'>
                <div class='container'>
                    <div class='row align-items-center'>
                        <div class='col-lg-7'>
                            <div class='section_title'>
                        ...
                        <div class='col-lg-5'>
                            <div class='button_box'>
                                <a href='" . $this->bs->cta_section_button_url . "' class='lawyer_btn'>" . convertUtf8($this->bs->cta_section_button_text) . "</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class='non-editable-area' data-gjs-stylable='false' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-removable='false' data-gjs-propagate=" . '["removable","editable","draggable","stylable"]' . ">
                            ...
                            <div class='row categories-slide'>";
                                foreach ($fcategories as $category) {
                                    $pcatsec .= "<a href='" . route('frontend.product', ['category_id' => $category->id]) . "' class='col categories-item'>
                                        <div class='cat-img'>
                                            <img src='" . asset('assets/frontend/images/product/categories/' . $category->image) . "' alt=''>
                                        </div>
                                    ...
                                    <div class='featured-slide row'>";
                                        ...
                                        foreach ($fproducts as $product) {
                                            $fprodsec .= "<div class='shop-item col-2'>
                                                <a class='shop-img' href='" . route('frontend.product.Details',$product->slug) . "'>
                                                    <img class='lazy w-100' data-src='" . asset('assets/frontend/images/product/featured/'.$product->feature_image) . "' alt=''>
                                                </a>
                                                <div class='shop-info'>";
                                                    ...
                                                    $fprodsec .= "<h3><a href='" . route('frontend.product.Details',$product->slug) . "'>" . (strlen($product->title) > 40 ? mb_substr($product->title,0,40,'utf-8') . '...' : $product->title) . "</a></h3>";
                                    ...
                                    foreach ($category->products as $product) {
                                        $hcatsec .= "<div class='shop-item col-2'>
                                            ...
                                            <div class='shop-info'>";
                                                ...
                                                $hcatsec .= "<h3><a href='" . route('frontend.product.Details',$product->slug) . "'>" . (strlen($product->title) > 40 ? mb_substr($product->title,0,40,'utf-8') . '...' : $product->title) . "</a></h3>";
                                                if ($bex->catalog_mode == 0) {
                    ...
                    <div class='row justify-content-center'>
                        <div class='col-lg-8'>
                            <div class='section-title text-center mb-20'>
                                <h2>" . $this->bs->blog_section_title . "</h2>
                            </div>
                        </div>
                    </div>
                    <blogs-section>
                                ...
                                foreach ($blogs as $key => $blog) {
                                    $blogSec .= "<div class='col-3 blog-item mb-40'>
                                        <div class='post-thumb'>
                                            <img class='lazy w-100' data-src='" . asset('assets/frontend/images/blogs/'.$blog->main_image) . "' alt=''>
                                            <a href='#' class='cat'>" . (!empty($blog->bcategory) ? $blog->bcategory->name : '') . "</a>
                                        </div>
                                        <div class='entry-content'>
                                            <h3 class='title'><a href='" . route('frontend.blogDetails', [$blog->slug, $blog->id]) . "'>" . (strlen($blog->title) > 40 ? mb_substr($blog->title, 0, 40, 'utf-8') . '...' : $blog->title) . "</a></h3>
                                            <div class='post-meta'>
                                                <ul>";
                                ...
                                <div class='row sponsor-slide'>";
                                    foreach ($partners as $key => $partner) {
                                        $partnerSec .= "<div class='sponsor-item col-3 mx-0'>
                                            <a href='" . $partner->url . "' target='_blank'><img data-src='" . asset('assets/frontend/images/partners/'.$partner->image) . "' class='lazy w-100' alt=''></a>
                                        </div>";
                                    }
                                $partnerSec .= "</div>
                            </div>
                            ...
                            <newsletter-section>
                                <div class='non-editable-area' data-gjs-stylable='false' data-gjs-draggable='false' data-gjs-editable='false' data-gjs-propagate=" . '["editable","draggable","stylable"]' . ">
                                    ...
                                    <div class='newsletter-form'>
                                        <form class='footer-newsletter' id='footerSubscribeForm' action='" . route('frontend.subscribe') . "' method='post'>
