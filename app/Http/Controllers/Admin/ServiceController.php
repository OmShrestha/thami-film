...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->filled('image')) {
            ...
            @copy($image, 'assets/frontend/images/services/' . $filename);
        ...
        $service->content = str_replace(url('/') . '/assets/frontend/images/', "{base_url}/assets/frontend/images/", $request->content);
        $service->save();
