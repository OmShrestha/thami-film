...
class PortfolioController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    $in['slug'] = $slug;
    $in['content'] = str_replace(url('/') . '/assets/frontend/images/', "{base_url}/assets/frontend/images/", $request->content);

    if ($request->filled('image')) {
      $filename = uniqid() . '.' . $extImage;
      @copy($image, 'assets/frontend/images/portfolios/featured/' . $filename);
    ...
    foreach ($sliders as $key => $slider) {
      ...
      @copy($slider, 'assets/frontend/images/portfolios/sliders/' . $filename);
  ...
  public function images($portid)
  {
    ...
    foreach ($images as $key => $image) {
      $convImages[] = url("assets/frontend/images/portfolios/sliders/$image->image");
    }
